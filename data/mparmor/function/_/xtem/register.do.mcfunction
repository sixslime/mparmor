...
data modify storage mparmor:var register.attributes append value {type:"minecraft:armor", operation:"add_value"}
...
data modify storage mparmor:var register.attributes append value {type:"minecraft:armor_toughness", operation:"add_value"}
...
data modify storage mparmor:var register.attributes append value {type:"minecraft:movement_speed", operation:"add_multiplied_base"}
...
data modify storage mparmor:var register.attributes append value {type:"minecraft:knockback_resistance", operation:"add_value"}
data modify storage mparmor:var register.attributes[-1].amount set from storage mparmor:var register.target_item.stats.knockback_resist

data modify storage mparmor:var register.attributes[].id set value "mparmor:stat"
function mparmor:_/xtem/register.do.1 with storage mparmor:var register.target_item
data modify storage mparmor:var register.attributes[].slot set from storage mparmor:var register.target_item.slot

data modify storage mparmor:var register.item.components."minecraft:max_damage" set from storage mparmor:var register.target_item.durability
